...
def run3_b():
    ...
    rightMotor.on_for_rotations(-5, 0.09, brake=True, block=True)
    ...
    print("dropping arm")
    mdiff.on_for_distance(20, 28, brake=True, block=True) #go for less here
    print("forward into mission complete")
    leftMotor.on_for_rotations(-5, 0.065, brake=True, block=True)
    print("turned")
    mdiff.on_for_distance(20, 47, brake=True, block=True)
    print("move backwards out of mission complete")
    leftMotor.on_for_rotations(-5, -0.078, brake=True, block=True)
    ...
    print("turned")
    med.on_for_rotations(20, 1.2, brake=True, block=True)
    print("bring arm up")
    mdiff.on_for_distance(15, 55, brake=True, block=True)
    rightMotor.on_for_rotations(-5, 0.61, brake=True, block=True)
    print("turn left until at phone flip ")
    mdiff.on_for_distance(5, 70, brake=True, block=True)
    med.on_for_rotations(15, -1.6, brake=True, block=True)
    print("bring arm down till ground")
    rightMotor.on_for_rotations(-5, 0.05, brake=True, block=True)

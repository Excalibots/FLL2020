...
def run3_b():
	...
	rightMotor.on_for_rotations(-5, 0.09999, brake=True, block=True)
	...
	print("turned")
	mdiff.on_for_distance(20, 43, brake=True, block=True)
    ...
    #print("bring arm up")
    #mdiff.on_for_distance(15, 70, brake=True, block=True)
    ...
    #med.on_for_rotations(15, -1.65, brake=True, block=True)
    ...
    #med.on_for_rotations(50, 10, brake=True, block=True)
    #print("flip phone")
